...
public class DapperMovieRepository : IMovieRepository
{
   private readonly IDbConnectionFactory _dbConnectionFactory;
    ...
    public DapperMovieRepository(IDbConnectionFactory dbConnectionFactory)
    {
    ...
    public async Task<Movie?> GetByIdAsync(Guid id, Guid? userId = default, CancellationToken token = default)
    {
        ...
        var movie = await connection.QuerySingleOrDefaultAsync<Movie>(
            ...
            select m.*, round(avg(r.rating), 1) as AverageRating, myr.rating as UserRating 
            from movies m
    ...
    public async Task<IEnumerable<Movie>> GetAllAsync(GetAllMoviesOptions options, CancellationToken token = default)
    {
        ...
        // See GetAllMoviesOptionsValidator.cs for SQL Injection prevention.
